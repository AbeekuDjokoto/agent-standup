/** Shared auth form card — tuned for mobile Safari and larger screens. */
...
export const authCardSubtitleClassName =
  'max-w-[318px] text-center text-sm leading-5 text-neutral-grey-500 sm:text-base sm:leading-6';
